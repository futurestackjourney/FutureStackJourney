...
export function Room(props) {
  ...
  const matcapTexture = useTexture("/images/textures/mat4.png");
  const matcapTexture2 = useTexture("/images/textures/mat2.png");
  ...
  const radiatorPipeMaterial = new THREE.MeshPhongMaterial({
    color: "#fff",
  });
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        material={materials.blinn1}
      />
      <mesh geometry={nodes.table_blinn1_0.geometry} material={bodyMaterial2} />
      <mesh
